...
const ProductDetail = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-300 via-blue-100 to-white p-12">
      <div className="relative w-full max-w-5xl bg-white shadow-xl rounded-2xl p-12 transform transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="mt-6 flex gap-12 items-center justify-center">
