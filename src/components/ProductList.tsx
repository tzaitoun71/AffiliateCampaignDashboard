        ...
        {loading ? (
          ...
          <div className="overflow-hidden">
            <table className="w-full border-collapse shadow-lg rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-blue-700 text-white text-lg uppercase rounded-t-lg">
                  <th className="p-5 w-[600px] text-left">Product</th>
                  <th className="p-5 w-[250px] text-center">Category</th>
                  <th className="p-5 w-[200px] text-center">Price</th>
              ...
              <tbody>
                {products.map((product) => (
                  <tr
                    key={product.id}
                    className={`border-t transition-all duration-200 "bg-white"
